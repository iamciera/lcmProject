...
output: pdf_document
---
# Analysis 10 - Comparing clusters of tf2
...
plot_grid(one, two, three, four, five, six ncol = 2)
...
## write.csv(data.valOutput, "../data/output/analysis10.small.100917_tf2.csv", row.names = FALSE)
```
...
dim(results_sig) # 47 GO terms
levels(as.factor(results_sig$term)) #41 GO terms

# Write out for supplemental dataset

## write.csv(results_sig, "../data/output/lcmSOM_analysis10_03292018_redo_sigGOterms_tf2.csv")
```
